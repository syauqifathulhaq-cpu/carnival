...
@section('title', 'Riwayat Tiket | Carnival')

@section('content')
<div class="container" style="max-width: 1000px; margin: 3rem auto; padding: 0 2rem;">
    
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <h1 style="font-size: 2rem; color: var(--text-muted);" class="event-title">Riwayat Tiket</h1>
    ...
    @if($transactions->isEmpty())
        <div style="text-align: center; padding: 5rem 0; opacity: 0.7; background: var(--card-bg-light); border-radius: 12px;" class="dark-mode-card">
            ...
            <p>Belum ada riwayat tiket atau acara yang sudah selesai.</p>
        </div>
    @else
        <div style="display: grid; gap: 2rem;">
            @foreach($transactions as $trx)
                <div style="background: var(--card-bg-light); border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05); filter: grayscale(80%); opacity: 0.8;" class="dark-mode-card">
                    <!-- Header Transaksi -->
                    <div style="background: #555; color: #fff; padding: 1rem 1.5rem; display: flex; justify-content: space-between; align-items: center;">
                        <div>
                    ...
                    <div style="padding: 1.5rem;">
                        ...
                        @else
                            ...
                            <div style="border: 1px dashed rgba(255,255,255,0.1); border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem; display: grid; grid-template-columns: 1fr auto; gap: 2rem; align-items: center; background: rgba(255,255,255,0.02);" class="ticket-card">
                                ...
                                <div style="text-align: right;">
                                    @if($ticket->checkin_status == 'not_used')
                                        <div style="color: #6c757d; font-weight: bold; margin-bottom: 0.5rem;">❌ Tidak Hadir (Expired)</div>
                                    @else
                                        <div style="color: #6c757d; font-weight: bold; margin-bottom: 0.5rem;">✔️ Sudah Digunakan</div>
